    ...
    gameChoiceCard =
        ...
        <div class="card border-secondary text-center"> \
                    <div class="card-body"> \
                        ...
                        <button type="button" id="sentenceFlashButton" class="btn btn-warning btn-block m-1"><i class="fas fa-pen-alt"></i> Sentence Flash Cards</button>\
                        <button type="button" id="nameThatNounButton" class="btn btn-danger btn-block m-1"><i class="fas fa-globe-africa"></i> Name that Noun</button>\
                        <button type="button" id="nounGenderButton" class="btn btn-dark btn-block m-1"><i class="fas fa-venus-mars"></i> Noun Genders</button>\
                    </div> \
                    </div> \
                </div>';
    //placing the intro card in the content div
